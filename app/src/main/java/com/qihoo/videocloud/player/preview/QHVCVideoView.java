        ...
        this.infoListener = new IQHVCPlayer.OnInfoListener() {
            ...
            public void onInfo(int handle, int what, int extra) {
                if (QHVCVideoView.this.onInfoListener != null) {
                    //                    if (msgId == PlayerCallback.DEVICE_RENDER_FIRST_FRAME) {
                    //                        // first frame display
                    //                        if (mOnPlayStateListener != null) {
                    //                            if (mOnPlayStateListener != null)
                    //                                mOnPlayStateListener.onPlayFirstFrame();
                    //                        }
                    //                    } else if (msgId == PlayerCallback.DEVICE_RENDER_ERR) {
                    //                        // err
                    //                        if(Logger.LOG_ENABLE){
                    //                            Logger.e(TAG, "dvrender err");
                    //                        }
                    //                    }else if (msgId == PlayerCallback.DEVICE_RENDER_QUERY_SURFACE) { //修改条件
                    //                        if (playView != null) {
                    //                            if (!isPause) {//添加判断
                    //                                playView.render_proc(msgId, val);
                    //                            }
                    //                        }
                    //                    } else if (msgId == PlayerCallback.JPLAYER_MSG_DVRENDER_RESETSURFACE) { //添加
                    //                        if (playView != null) {
                    ...
                    } /*else if (what == IQHVCPlayer.INFO_DEVICE_RENDER_SURFACE_CHANGE) {
                      }*/
